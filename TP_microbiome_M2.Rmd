...
Nous utiliserons des profils taxonomiques MetaPhlAn issus du Human Microbiome Project.
...
```{r}
ord <- ordinate(ps.filt, method = "PCoA", distance = "bray")

plot_ordination(ps.filt, ord, color = "body_site") +
  geom_point(size = 3) +
  theme_bw()
```
